...
func (ec *executionContext) _Transaction_amount(ctx context.Context, field graphql.CollectedField, obj *model.Transaction) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNMoney2githubᚗcomᚋarikkfirᚋgreenstarᚋapiᚋmodelᚐMoney(ctx, field.Selections, res)
}
...
func (ec *executionContext) unmarshalNMoney2githubᚗcomᚋarikkfirᚋgreenstarᚋapiᚋmodelᚐMoney(ctx context.Context, v interface{}) (model.Money, error) {
	var res model.Money
	err := res.UnmarshalGQLContext(ctx, v)
	return res, graphql.ErrorOnPath(ctx, err)
}

func (ec *executionContext) marshalNMoney2githubᚗcomᚋarikkfirᚋgreenstarᚋapiᚋmodelᚐMoney(ctx context.Context, sel ast.SelectionSet, v model.Money) graphql.Marshaler {
...
func (ec *executionContext) marshalNTransaction2githubᚗcomᚋarikkfirᚋgreenstarᚋapiᚋmodelᚐTransaction(ctx context.Context, sel ast.SelectionSet, v model.Transaction) graphql.Marshaler {
	return ec._Transaction(ctx, sel, &v)
}

func (ec *executionContext) marshalNTransaction2ᚖgithubᚗcomᚋarikkfirᚋgreenstarᚋapiᚋmodelᚐTransaction(ctx context.Context, sel ast.SelectionSet, v *model.Transaction) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
