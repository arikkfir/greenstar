...
import {
    AccountsForScraperAccountParameterQuery,
    ScraperJobsQuery,
    ScrapersQuery,
    ScraperTypesQuery,
...
export const ScraperJobLogs = gql(`
    query ScraperJobLogs($tenantID: ID!, $scraperID: ID!, $scraperJobID: ID!, $page: Int, $pageSize: Int) {
        tenant(id: $tenantID) {
            id
            scraper(id: $scraperID) {
                id
