...
export type AccountsForScraperAccountParameterQuery = { __typename?: 'Query', tenant?: { __typename?: 'Tenant', accounts: Array<{ __typename?: 'Account', id: string, displayName: string }> } | null };
...
export type ScraperJobQuery = { __typename?: 'Query', tenant?: { __typename?: 'Tenant', id: string, scraper?: { __typename?: 'Scraper', id: string, job?: { __typename?: 'ScraperJob', id: string, createdAt: DateTime, status: ScraperJobStatus, parameters: Array<{ __typename?: 'ScraperParameter', value: string, parameter: { __typename?: 'ScraperTypeParameter', id: string, displayName: string, type: ScraperParameterType } }> } | null } | null } | null };
...
export type ScraperJobLogsQueryVariables = Exact<{
  tenantID: Scalars['ID']['input'];
  scraperID: Scalars['ID']['input'];
  scraperJobID: Scalars['ID']['input'];
  page?: InputMaybe<Scalars['Int']['input']>;
...
export type ScraperJobLogsQuery = { __typename?: 'Query', tenant?: { __typename?: 'Tenant', id: string, scraper?: { __typename?: 'Scraper', id: string, job?: { __typename?: 'ScraperJob', id: string, logs: Array<string> } | null } | null } | null };
...
export const ScraperJobLogsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"ScraperJobLogs"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"tenantID"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"scraperID"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"scraperJobID"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"page"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"pageSize"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"tenant"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"tenantID"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"scraper"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"scraperID"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"job"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"scraperJobID"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"logs"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"page"},"value":{"kind":"Variable","name":{"kind":"Name","value":"page"}}},{"kind":"Argument","name":{"kind":"Name","value":"pageSize"},"value":{"kind":"Variable","name":{"kind":"Name","value":"pageSize"}}}]}]}}]}}]}}]}}]} as unknown as DocumentNode<ScraperJobLogsQuery, ScraperJobLogsQueryVariables>;
