...
import (
	...
	"github.com/arikkfir/greenstar/backend/admin/resolver"
...
func main() {
	...
	graphResolver := &resolver.Resolver{Neo4j: neo4jDriver}
	...
	router.Use(auth.CreateVerifyTokenMiddleware("greenstar.auth", "greenstar.admin"))
